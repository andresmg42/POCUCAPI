"""
Django settings for pocuc project.
...
SECRET_KEY = 'django-insecure-lbfw#ag#*cv#15^3^^cw$8!h1zcdw($h7*u_@q*yb@iw88llt^'
...
WSGI_APPLICATION = 'pocuc.wsgi.application'
